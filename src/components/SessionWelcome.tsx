        ...
        <Paper elevation={8} sx={{ p: 2.5, borderRadius: 2 }}>
          ...
          <Alert severity="info" icon={false} sx={{ borderRadius: 1 }}>
            <Typography variant="body2" sx={{ textAlign: "justify", mb: 1.5 }}>
              This App is not affiliated to SQU. Course details may be outdated
              or incomplete; always verify in the official SIS. Data shown here
              is not synced live with SIS.
              <br />
              <br />
            </Typography>
            {lastUpdateData && (
